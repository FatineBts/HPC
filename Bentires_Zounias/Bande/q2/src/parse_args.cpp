...
void parse_args(int argc, char **argv) {
  ...
  desc.add_options()
    ...
    ("gsize_x,x", po::value<int>()->default_value(256), "Global Size of the first dimension of the domain")
    ("gsize_y,y", po::value<int>()->default_value(256), "Global Size of the second dimension of the domain")
  ...
  gsize_x = vars["gsize_x"].as<int>();
  gsize_y = vars["gsize_y"].as<int>();
